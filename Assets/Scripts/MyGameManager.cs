...
public class MyGameManager : MonoBehaviour
{
    ...
    void Start()
    {
        //ApplicationData.HowManyViruses = 60;///here is where we decide how many viruses to spawn
        ...
        MakeNewInjectorR();///call function to make first new injector on left hand
